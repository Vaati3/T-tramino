...
function put_tetris(tetris, x)
	if (tetris == 4 and x == 0) then
		update_line(-32, 120, 64, 120) 
		p2_m += 4 end
	if (tetris == 3 and x == 0) then
		update_line(-16, 120, 64, 120)
		p2_m += 2 end
end
...

...

